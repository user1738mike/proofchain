  ...
  return (
    <div className="flex h-screen bg-black text-white">
      ...
      <div className="w-1/2 bg-gradient-to-b from-purple-600 to-purple-900 flex flex-col items-center justify-center p-8">
        ...
        <p className="text-sm text-center mb-8">Customize your workspace to match your needs.</p>
        ...
        <div className="w-full max-w-xs space-y-3">
          <button className="w-full bg-black bg-opacity-20 rounded-full py-3 px-4 font-medium flex items-center justify-center">
            <span className="h-4 w-4 bg-white bg-opacity-20 rounded-full mr-2 flex items-center justify-center text-xs">1</span>
            Sign up your account
          </button>
          
          <button className="w-full bg-white text-black rounded-full py-3 px-4 font-medium flex items-center justify-center">
            <span className="h-4 w-4 bg-black rounded-full mr-2 flex items-center justify-center text-white text-xs">2</span>
      ...
      <div className="w-1/2 flex items-center justify-center">
        <div className="w-full max-w-md px-8">
          ...
          <p className="text-sm text-gray-400 mb-6">Configure your workspace environment.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  type="button"
                  onClick={() => setWorkspaceData({ ...workspaceData, type: "personal" })}
                  className={
                ...
                >
                  ...
                  <div className="text-xs text-gray-400">For individual use</div>
                </button>
                <button
                  type="button"
                  onClick={() => setWorkspaceData({ ...workspaceData, type: "team" })}
                  className={
